<template>
    ...
    <div class="content">
        <div class="form">
            <!-- Title -->
            <div class="title">
                <span class="z-10 mx-auto">{{ useLanguageStore.pages[home]?.[nowLanguage]?.title }}</span>
            ...
            <input type="text" v-model="name" @input="inputAvatar"
                :placeholder="useLanguageStore.pages[home]?.[nowLanguage]?.tipInputPlaceholder"
                class="input input-bordered input-primary z-10" />
            <!-- button -->
            <div class="action">
                <div class="tooltip tooltip-bottom"
                    :data-tip="useLanguageStore.pages[home]?.[nowLanguage]?.tipRandomAvatar">
                    <button class="btn z-10" @click="randomAvatar">⭕</button>
                </div>
                <div class="tooltip tooltip-bottom" :data-tip="useLanguageStore.pages[home]?.[nowLanguage]?.tipGender">
                ...
                <div class="tooltip tooltip-bottom" :data-tip="useLanguageStore.pages[home]?.[nowLanguage]?.tipStart">
